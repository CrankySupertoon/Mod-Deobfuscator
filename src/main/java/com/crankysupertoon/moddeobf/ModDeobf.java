...
import com.crankysupertoon.moddeobf.cli.CLIErrorHandler;
import com.crankysupertoon.moddeobf.cli.CLIProgressListener;
...
public class ModDeobf {
    ...
    private static void parseArgs(String[] args) throws Exception {
        ...
        try {
            ...
            log(VERSION);
            log("Obfuscated Mod:       " + inputJar);
            log("Deoubscated Mod:      " + outputJar);
            log("Notch:           " + notch);
            log("Minecraft:       " + mcp);
            ...
            try {
                ...
                ModDeobfImpl.remap(new File(inputJar), new File(outputJar), notch ? mcp : null, mapping, errorHandler, progress);
            } catch(Exception e) {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ModDeobfGui frame = new ModDeobfGui();
